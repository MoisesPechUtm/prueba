...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="form-container">
        <h2>Agregar Mercancia</h2>
        <form action="/guardar_mercancia" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" id="precio" name="precio" value="{{ empty($precio) ? '' : $precio }}">
            </div>
            <div class="form-group">
            ...
            <a href="/listado_mercancia">Cancelar</a>
        </form>
    </div>
