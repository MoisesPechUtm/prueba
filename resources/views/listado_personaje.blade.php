...
<a href="formulario_personajes" class="btn btn-success mb-3">Agregar Personaje</a>
        ...
        <tbody>
            @foreach($personajes as $registro)
                <tr>
                    ...
                    <td>
                        <a href='formulario_personajes/{{ $registro["id"] }}'>Editar</a>
                        <a href='eliminar_personaje/{{ $registro["id"] }}'>Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
