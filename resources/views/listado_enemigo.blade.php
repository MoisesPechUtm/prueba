...
<a href="formulario_enemigos" class="btn btn-success mb-3">Agregar Enemigos</a>
        ...
        <tbody>
            @foreach($enemigo as $registro)
                <tr>
                    ...
                    <td><img src="/imagenes_enemigos/{{ $registro['imagen'] }}" width="100"></td>
                    <td>
                        <a href='formulario_enemigos/{{ $registro["id"] }}'>Editar</a>
                        <a href='eliminar_enemigo/{{ $registro["id"] }}'>Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
