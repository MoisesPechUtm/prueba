...
<a href="formulario_mercancias" class="btn btn-success mb-3">Agregar Mercancia</a>
    <h1>Listado de Mercancia</h1>
        ...
        <tbody>
            @foreach($mercancia as $registro)
                <tr>
                    ...
                    <td><img src="/imagenes_mercancias/{{ $registro['imagen'] }}" width="100"></td>
                    <td>
                        <a href='formulario_mercancias/{{ $registro["id"] }}'>Editar</a>
                        <a href='eliminar_mercancia/{{ $registro["id"] }}'>Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
