...
<a href="formulario_plataformas" class="btn btn-success mb-3">Agregar Plataformas</a>
        ...
        <tbody>
            @foreach($plataformas as $registro)
                <tr>
                    ...
                    <td><img src="/imagenes_plataformas/{{ $registro['imagen'] }}" width="100"></td>
                    <td>
                        <a href='formulario_plataformas/{{ $registro["id"] }}'>Editar</a>
                        <a href='eliminar_plataforma/{{ $registro["id"] }}'>Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
