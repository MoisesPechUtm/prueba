...
<a href="formulario_powerups" class="btn btn-success mb-3">Agregar Power Ups</a>
    <h1>Listado de Power Ups</h1>
        ...
        <tbody>
            @foreach($powerups as $registro)
                <tr>
                    ...
                    <td><img src="/imagenes_powerups/{{ $registro['imagen'] }}" width="100"></td>
                    <td>
                        <a href='formulario_powerups/{{ $registro["id"] }}'>Editar</a>
                        <a href='eliminar_powerup/{{ $registro["id"] }}'>Eliminar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
